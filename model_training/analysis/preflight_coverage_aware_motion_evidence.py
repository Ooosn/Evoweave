...
def main() -> None:
    ...
    if args.eval_only:
        ...
        result = {
            ...
            "acceptance": {
                ...
                "custom_attention_matches_legacy": evaluation["legacy_custom_logit_max_abs_diff"] <= 1.0e-5,
    ...
    result = {
        ...
        "acceptance": {
            ...
            "custom_attention_matches_legacy": after["legacy_custom_logit_max_abs_diff"] <= 1.0e-5,
